...
<body>
    <?php if (empty($admin) || !$admin): ?> <!-- Esto es por si estoy como admin no se muestre el menu -->
        <header>
    ...
    <?php if (empty($admin) || !$admin): ?> <!-- Esto es por si estoy como admin no se muestre el footer -->
        <footer>
