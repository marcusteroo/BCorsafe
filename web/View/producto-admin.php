<div class="admin-principal-container">
    ...
    <div class="titulo-producto-admin">
        <h1>Panel de Administración - Productos</h1>
        <div id="productosContainer" class="productos-container-admin">
            
            <!-- Aquí se llenarán los productos dinámicamente -->
        </div>
        <a class="boton-tres-pedidos" href="/BCorsafe/admin/NewProductoAdmin">Añadir Producto</a>
